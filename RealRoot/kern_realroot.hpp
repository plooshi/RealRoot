...
const uint8_t apfsVfsopMountOrigMonterey[] = {
...
const uint8_t apfsVfsopMountMaskMonterey[] = {
...
const uint8_t apfsVfsopMountMaskBigSur[] = {
    0xff, 0x00, 0x00, 0x00, 0x00,
    0xff, 0xff, 0xff, 0x00, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff,
    0xff, 0xfe, 0x00, 0x00, 0x00, 0x00,
...
const uint8_t SnapshotOrigBigSur[] = {
    0xbf, 0x10, 0x00, 0x00, 0x00, // mov edi, 0x10
    0xe8, 0x00, 0x00, 0x00, 0x00, // call _csr_check
    0x89, 0xc3, // mov ebx, eax
    0xbf, 0x00, 0x08, 0x00, 0x00, // mov edi, 0x800
    ...
    0x85, 0xc0, // test eax, eax
    0x0f, 0x84, 0x00, 0x00, 0x00, 0x00, // je
    0x48, 0x8b, 0x9d, 0x00, 0x00, 0x00, 0x80,  // mov rbx, qword ptr [rbp-_V1]
    0x48, 0x8b, 0x85, 0x00, 0x00, 0x00, 0x80,  // mov rax, qword ptr [rbp-_V1]
    0x48, 0x85, 0xdb, // test rbx, rbx
    0x74, 0x00 // je
};

const uint8_t SnapshotMaskBigSur[] = {
    0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0x00, 0x00, 0x00, 0x00,
    0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff,
...
const uint8_t SnapshotReplaceBigSur[] = {
    0xbf, 0x10, 0x00, 0x00, 0x00, // mov edi, 0x10
    0xe8, 0x00, 0x00, 0x00, 0x00, // call _csr_check
    0x89, 0xc3, // mov ebx, eax
    0xbf, 0x00, 0x08, 0x00, 0x00, // mov edi, 0x800
...
const uint8_t SnapshotReplaceMaskBigSur[] = {
    0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0x00, 0x00, 0x00, 0x00,
    0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff,
